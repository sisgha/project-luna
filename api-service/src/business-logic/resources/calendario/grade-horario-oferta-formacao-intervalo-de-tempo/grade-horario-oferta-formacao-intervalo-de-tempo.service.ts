import { IntervaloDeTempoService } from "@/business-logic/resources/base/intervalo-de-tempo/intervalo-de-tempo.service";
import { GradeHorarioOfertaFormacaoService } from "@/business-logic/resources/calendario/grade-horario-oferta-formacao/grade-horario-oferta-formacao.service";
...
export class GradeHorarioOfertaFormacaoIntervaloDeTempoService {
  ...
  async gradeHorarioOfertaFormacaoIntervaloDeTempoFindAll(
    ...
    LadesaTypings.GradeHorarioOfertaFormacaoIntervaloDeTempoListOperationOutput["success"]
  > {
    // =========================================================
    ...
    qb.select([]);
    QbEfficientLoad(
      LadesaTypings.Tokens.GradeHorarioOfertaFormacaoIntervaloDeTempoView,
      qb,
      aliasGradeHorarioOfertaFormacaoIntervaloDeTempo,
      selection
    );
