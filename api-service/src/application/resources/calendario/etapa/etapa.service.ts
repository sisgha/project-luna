...
export class EtapaService {
  ...
  async etapaFindAll(
    ...
    QbEfficientLoad(
      LadesaTypings.Tokens.EtapaFindOneResultView,
      qb,
      aliasEtapa,
      selection
    );
  ...
  async etapaFindById(
    ...
    selection?: string[] | boolean
  ): Promise<LadesaTypings.EtapaFindOneResultView | null> {
    // =========================================================
  ...
  async etapaFindByIdSimple(
    accessContext: AccessContext,
    id: LadesaTypings.EtapaFindOneInputView["id"],
    selection?: string[]
  ): Promise<LadesaTypings.EtapaFindOneResultView | null> {
    // =========================================================
  ...
  async etapaUpdate(
    ...
    await accessContext.ensurePermission(
      ...
      { dto },
      dto.params.id,
      this.etapaRepository.createQueryBuilder(aliasEtapa)
    );
